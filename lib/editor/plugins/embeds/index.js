class Frame {
  static get toolbox() {
    return {
      title: "Link Embeds",
      icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20"><path fill="none" d="M0 0h24v24H0z"/><path d="M20.083 10.5l1.202.721a.5.5 0 0 1 0 .858L12 17.65l-9.285-5.571a.5.5 0 0 1 0-.858l1.202-.721L12 15.35l8.083-4.85zm0 4.7l1.202.721a.5.5 0 0 1 0 .858l-8.77 5.262a1 1 0 0 1-1.03 0l-8.77-5.262a.5.5 0 0 1 0-.858l1.202-.721L12 20.05l8.083-4.85zM12.514 1.309l8.771 5.262a.5.5 0 0 1 0 .858L12 13 2.715 7.429a.5.5 0 0 1 0-.858l8.77-5.262a1 1 0 0 1 1.03 0z"/></svg>',
    };
  }
  ...
  render() {
    ...
    if (this.data && this.data.url) {
      ...
      this.wrapper.classList.add("container-embed");
  ...
  _createIframe(url) {
    ...
    const imageContainer = this._make(
      "div",
      ["text-center", "mx-auto", "embed-spinner"],
  ...
  _createFrame(url, imageContainer, text) {
    ...
    var data = null;
    frame.width = "100%";
    fetch(`https://embeds.codingbolt.com/iframely?url=${url}`).then((res) => {
      res
        .json()
        .then((reso) => {
